...
class _AIPageState extends State<AIPage> {
  ...
  Future<void> generateImage() async {
    if (_controller.text.isNotEmpty) {
      ...
      var data = {
        "model": "dall-e-3",
        "prompt": "White background, a single icon with no unnecessary detail, child-friendly, continuous line art no spaces, no text, simple icon of " + _controller.text,
        "n": 1,
        "size": "1024x1024",
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: const Text('Generer billede',
            ...
            isLoading
              ...
              : Column(
                children: [
                  ...
                  : const Text('Intet billede genereret',
                  ...
                  image != null
                    ? ElevatedButton(
                        onPressed: () {
                          // Save image functionality will be added later
                        },
                        child: const Text(
                          'Gem billede',
                          style: TextStyle(color: Colors.white),
        ...
        children: [
          ...
          Center(
            child: Container(
              ...
              decoration: BoxDecoration(
                color: const Color(0xFFF5F2E7), // Set the background color of the container
